...
\thiswatermark{\centering \put(0,-90.0){\includegraphics[scale=0.05]{logo.jpg}} }
\title{\mytitle}
...
\begin{table}[htbp]
 \begin{center}
    \begin{tabular}{|l|c|c|c|c|c|c|c|c} \hline \textbf{Vaman}
  & \textbf{34} & \textbf{39} & \textbf{38}& \textbf{32}& \textbf{10}& \textbf{Vcc}& \textbf{gnd} \\
 \hline
Input&X&Y&Z&W&F&&\\ \hline
led&&&&&&+&- \\ \hline
\end{tabular}   
\end{center}
\caption{\label{table:dummytable} }
